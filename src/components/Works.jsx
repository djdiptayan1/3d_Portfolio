    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        <div className='relative w-full h-[230px]'>
          ...
          <div className='nav-cursor absolute inset-0 flex justify-end m-3 card-img_hover'>
            <div
    ...
    <>
      ...
      <div className='StanLee w-full flex'>
        ...
        >
          ...
          and manage projects effectively.<span className="text-blue-400"><a className="nav-cursor" href="https://github.com/djdiptayan1" target="_blank">  View All Projects...</a></span>
        </motion.p>
      </div>
